...
while($d=mysql_fetch_array($det)){
	?>					
	<form action="update_barang_laku.php" method="post">
		<table class="table">
			<tr>
				<td></td>
			...
			<tr>
				<td>Nama Pembeli</td>
				<td><input name="nm_pembeli" type="text" class="form-control" id="nm_pembeli" autocomplete="off" value="<?php echo $d['nm_pembeli'] ?>"></td>
			</tr>
			<tr>
				<td>Tanggal</td>

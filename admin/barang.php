			...
			<div class="modal-body">
				<form action="tmb_brg_act.php" method="post">
					<div class="form-group">
						...
						<input name="nama" type="text" class="form-control" required="" placeholder="Nama Barang ..">
					</div>
					<div class="form-group">
						<label>Jenis</label>
						<input name="jenis" type="text" class="form-control" required=""  placeholder="Jenis Barang ..">
					</div>
					<div class="form-group">
						<label>Suplier</label>
					...
					<div class="form-group">
						...
						<input name="modal" type="text" class="form-control" required=""  placeholder="Modal per unit">
					</div>	
					<div class="form-group">
						<label>Harga Jual</label>
						<input name="harga" type="text" class="form-control" required=""  placeholder="Harga Jual per unit">
					</div>	
					<div class="form-group">
						<label>Jumlah</label>
						<input name="jumlah" type="text" class="form-control" required=""  placeholder="Jumlah">
					</div>																	

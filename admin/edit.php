...
?>					
	<form action="update.php" method="post">
		<table class="table">
			...
			<tr>
				<td>Nama</td>
				<td><input type="text" class="form-control" required="" name="nama" value="<?php echo $d['nama'] ?>"></td>
			</tr>
			<tr>
				<td>Jenis</td>
				<td><input type="text" class="form-control" required="" name="jenis" value="<?php echo $d['jenis'] ?>"></td>
			</tr>
			<tr>
				<td>Suplier</td>
